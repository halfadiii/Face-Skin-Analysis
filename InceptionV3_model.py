...
def create_model(num_classes):
    # Load InceptionV3 pre-trained on ImageNet, exclude the top layer
...
def main():
    ...
    train_generator = train_datagen.flow_from_directory(
        ...
        target_size=(299, 299),  # InceptionV3 uses 299x299 inputs
        batch_size=32,
    ...
    model.save(r'Models\skin_condition_model_inceptionv3.h5')
    print("Model saved as skin_condition_model_inceptionv3.h5")
